...
public class OnRunAlarmReceiver extends BroadcastReceiver {
 // Logging constants
    private static final boolean DEBUG = true;
    private static final String BENDELE = "BENDELE";
    private static final String CLASS = "onRunAlarmReceiver - ";
	...
	public void onReceive(Context context, Intent intent) {
        myLog("");
        WakefulIntentService.sendWakefulWork(context, RunAlarmService.class);
	}
}
